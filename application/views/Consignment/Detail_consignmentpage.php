<div style="margin: 50px;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <button onclick="history.back()" class="btn btn-primary"><< ย้อนกลับ</button>
                        ...
                        <div style="text-align: center;">
                            <!-- <img src="</?php echo base_url('assets/img/slide/' . $r->p_image); ?>" alt="properties" style="width:70%;text-align:center;" /> -->
                            <img src=" <?php echo base_url('property/'.$r->p_code .'/'. $r->p_image); ?>"
                                alt="properties" style="width:70%;text-align:center;" />
                        ...
                        <div style="color:black; font-size:15px">
                            ...
                            <p style="font-size: 15px; margin-bottom: 0rem;"><i style="color:#049bba"
                                    class="bi bi-house"></i> รหัสทรัพย์ : <?php echo $r->p_code ?></p>
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 15px; margin-bottom: 0rem;"><i class="bi bi-geo-alt"
                                    style="color:#049bba"></i> <?php echo $r->p_address ?></p>
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 15px; margin-bottom: 0rem;"><i class="bi bi-plus-square"
                                    style="color:#049bba"></i> พื้นที่ <?php echo $r->square_wah ?> ตร.วา</p>
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 15px; margin-bottom: 0rem;"><i class="bi bi-credit-card"
                                    style="color:#049bba"></i> มูลค่าทรัพย์ <?php echo $r->p_price ?> บาท</p>

                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 15px; margin-bottom: 0rem;"><i class="bi bi-credit-card"
                                    style="color:#049bba"></i> วงเงินขายฝาก <?php echo $r->price_limit ?> บาท</p>
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 15px; margin-bottom: 0rem;"><i class="bi bi-coin"
                                    style="color:#049bba"></i> ดอกเบี้ย <?php echo $r->percen ?> % </p>
                            <!-- <hr style="margin: 0.3rem 0;" />

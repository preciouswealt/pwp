<div style="margin: 20px;">
    <div class="container">
        <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <p> ตัวอย่าง นายเอกได้กู้เงินจากนายโทเป็นจำนวน 2 แสนบาท โดยนายเอกได้นำที่ดินของตนจำนวน 1 แปลงไปจดทะเบียนจำนองต่อพนักงานเจ้าหน้าที่ เพื่อเป็นการประกันการชำระหนี้เงินกู้จำนวน 2 แสนบาท ที่นายเอกได้กู้ไปจากนายโท โดยนายเอกไม่ต้องส่งมอบที่ดินของตนให้แก่นายโท นายเอกยังคงมีสิทธิครอบครองและใช้สอยที่ดินของตนได้ตามปกติ </p>
            <p>การจำนองเพื่อเป็นการประกันการชำระหนี้แก่ผู้รับจำนองนั้น แบ่งออกเป็น 6 กรณีคือ </p>
            <p>1. การจำนองทรัพย์ของตนเองเพื่อเป็นการประกันการชำระหนี้ของตนเองตัวอย่าง นายเอก ได้กู้เงินจากนายโท 2 แสนบาท โดยนายเอกนำที่ดินซึ่งเป็นของตนเองไปจดทะเบียนจำนองต่อพนักงานเจ้าหน้าที่เพื่อเป็นการประกันการชำระหนี้เงินกู้ของนายเอกเอง </p>
            <p>2. การจำนองเพื่อเป็นการประกันการชำระหนี้ของบุคคลอื่นตัวอย่าง นายเอกได้กู้เงินจากนายโท เป็นจำนวนเงิน 2 แสนบาท โดยนายตรีได้นำที่ดินของตนไปจดทะเบียนจำนองต่อพนักงานเจ้าหน้าที่ เพื่อเป็นประกันการชำระหนี้ที่นายเอกได้กู้ไปจากนายโท </p>
            <p>ทรัพย์สินที่อาจใช้ในการจำนองได้ แบ่งออกเป็น 2 ประเภทใหญ่ได้ 2 ประเภทกล่าวคือ </p>
            <p>1. อสังหาริมทรัพย์ เช่น ที่ดิน บ้าน หรือสิ่งปลูกสร้างทุกชนิดอันติดอยู่กับที่ดินนั้น </p>
            <p>2. สังหาริมทรัพย์ ที่จำนองได้ คือ </p>
            <p>ก. เรือกำปั่น เรือที่มีระวางตั้งแต่หกตันขึ้นไป เรือกลไฟ หรือเรือยนต์ที่มีระว่างตั้งแต่ห้าตันขึ้นไป </p>
            <p>ข. แพ </p>
            <p>ค. สัตว์พาหนะ </p>
            ...
            <form id="insurance" method="GET" action="<?php echo site_url("Home/mortgage") ?>">
                ...
                <div class="row">
                    <div class="col-md-4 ">
                        <table>
                            <td style="width: 120px;">
                                <label style="border: 1px solid #0597b5;background-color:#0597b5;color:#fff;padding:1px;border-radius:5px;width:117px;text-align:center;font-weight: 2;">ประเภททรัพย์</label>
                            </td>
                        </table>
                        <div style="padding: 3px">
                            <select class="form-control csscall js-example-basic-single" placeholder="Pick a state..." id="typeproperties" name="typeproperties" style="border: 1px solid #0597b5;">
                    ...
                    <div class="col-md-4 ">
                        <table>
                            <td style="width: 120px;">
                                <label style="border: 1px solid #0597b5;background-color:#0597b5;color:#fff;padding:1px;border-radius:5px;width:117px;text-align:center;font-weight: 2;">จังหวัด</label>
                            </td>
                        </table>
                        <div style="padding: 3px">
                    ...
                    <div class="col-md-4">
                        <table>
                            <td style="width: 120px;">
                                <label style="border: 1px solid #0597b5;background-color:#0597b5;color:#fff;padding:1px;border-radius:5px;width:117px;text-align:center;font-weight: 2;">อำเภอ</label>
                            </td>
                        </table>
                        <div style="padding: 3px">
                            <select class="form-control csscall js-example-basic-single" id="dristrict" name="dristrict" style="	border: 1px solid #0597b5;" onchange="getsubdistrict(this.value)">
                                ...
                                <?php if ($this->session->userdata("dristrict")) { ?>
                                    <option value="<?php echo  $this->session->userdata("dristrict"); ?>" selected><?php echo  $this->session->userdata("dristrictname"); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <table>
                            <td style="width: 120px;">
                                <label style="border: 1px solid #0597b5;background-color:#0597b5;color:#fff;padding:1px;border-radius:5px;width:117px;text-align:center;font-weight: 2;">ตำบล</label>
                            </td>
                        </table>
                        <div style="padding: 3px">
                            <select class="form-control csscall js-example-basic-single" style="border: 1px solid #0597b5;" id="sub_dristrict" name="sub_dristrict">
                                <option value="">เลือกตำบล</option>
                                <?php if ($this->session->userdata("sub_dristrict")) { ?>
                                    <option value="<?php echo  $this->session->userdata("sub_dristrict"); ?>" selected><?php echo  $this->session->userdata("sub_dristrictname"); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <table>
                            <td style="width: 120px;">
                                <label style="border: 1px solid #0597b5;background-color:#0597b5;color:#fff;padding:1px;border-radius:5px;width:117px;text-align:center;font-weight: 2;">ขนาด</label>
                            </td>
                        </table>
                        <div style="padding: 3px">
                            <select class="form-control csscall js-example-basic-single" style="border: 1px solid #0597b5;" id="size" name="size">
                                <option value="">เลือกขนาด</option>
                                <?php foreach ($square_wah as $sq) { ?>
                                    <?php if ($this->session->userdata("size") == $sq->square_wah) { ?>
                                        <option value="<?php echo $sq->square_wah; ?>" selected><?php echo $sq->square_wah; ?>. ตารางวา </option>
                                    <?php } else { ?>
                                        <option value="<?php echo $sq->square_wah; ?>"><?php echo $sq->square_wah; ?>. ตารางวา </option>
                                    <?php } ?>
                    ...
                    <div class="col-md-4 ">
                        <table>
                            <td style="width: 120px;">
                                <label style="border: 1px solid #0597b5;background-color:#0597b5;color:#fff;padding:1px;border-radius:5px;width:117px;text-align:center;font-weight: 2;">สถานะ</label>
                            </td>
                        </table>
                        <div style="padding: 3px">
                            <select class="form-control csscall js-example-basic-single" id="statusmatch" name="statusmatch" style="border: 1px solid #0597b5;">
                    ...
                    <div class="col-md-4 ">
                        ...
                        <input type="submit" class="form-control btn " style="font-size: 13px;background-color: #0597b5;height: 35px;color:#fff" value="ค้นหา">
                    </div>
                </div>
            </form>
            <br />

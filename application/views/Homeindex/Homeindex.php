    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="" role="listbox">
            ...
            <<div class="carousel-item active"
                style="background-image: url(<?php echo base_url('assets/img/slide/' . $i->nameimage); ?>)">
...
<main id="main">
            ...
            <div class="row gx-5">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <div class="position-relative">
                        <img class="position-absolute  rounded wow zoomIn" data-wow-delay="0.3s"
                            src="<?php echo base_url(); ?>assets/img/logo.jpg" style="object-fit: cover;width:100%">
                    </div>
                </div>
                <div class="col-lg-8">
                    <?php echo $b->detail; ?>
    ...
    <section id="featured-services" class="featured-services section-bg">
        <div class="container">
            <h2 style="text-align: center;" class="animate__animated animate__fadeInDown"><strong>ขายฝาก กับ <span
                        style="color:#049bba;">Precious</span> <span class="text-warning">wealth
                ...
                <div class="item">
                    <div class="card">
                        ...
                        <div class="card-body" style="height: 380px;">
                            ...
                            <hr style="border: 0px;" />
                            <p style="font-size: 13px; margin-bottom: 0rem;"><i style="color:#049bba"
                                    class="bi bi-house"></i> รหัสทรัพย์ : <?php echo $ipro->p_code ?></p>
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 13px; margin-bottom: 0rem;"><i class="bi bi-geo-alt"
                                    style="color:#049bba"></i> <?php echo $ipro->district.','.$ipro->supdistrict ?></p>
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 13px; margin-bottom: 0rem;"><i class="bi bi-plus-square"
                                    style="color:#049bba"></i> พื้นที่ <?php echo $ipro->square_meter ?> ตร.ม,
                                <?php echo $ipro->square_wah ?> ตร.วา</p>
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 13px; margin-bottom: 0rem;"><i class="bi bi-credit-card"
                                    style="color:#049bba"></i> มูลค่าทรัพย์  <?php 
                                if($ipro->p_price == ''){
                                    echo "x,xxx,xxx";
                                }else{ echo $ipro->p_price; } ?>
                                บาท</p>
                            <hr style="margin: 0.3rem 0;" />
                            <!-- <p style="font-size: 13px; margin-bottom: 0rem;"><i class="bi bi-credit-card"
                            ...
                            <a
                                href="<?php echo site_url('Detail_Propertyproject/' . $ipro->id . ''); ?>">...ดูรายละเอียด</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
                ...
                <div class="item">
                    <div class="card">
                        ...
                        <div class="card-body" style="height: 380px;">
                            ...
                            <!-- <a href="#">...ดูรายละเอียด</a> -->
                            <a
                                href="<?php echo site_url('Detail_Propertysale/' . $ipro->id . ''); ?>">...ดูรายละเอียด</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="height: 380px;">
                            <div style="text-align: center;">
                                ...
                                <?php if (strlen($ipro->p_name) > 70) { ?>
                                <p><b>
                                        <?php echo  mb_substr($ipro->p_name, 0, 70,'UTF-8') . "..."; ?></b></p>
                                <?php  } else { ?>
                                <p><b><?php echo  $ipro->p_name ?></b></p>
                                <?php  } ?>
                            </div>
                            ...
                            <hr style="margin: 0.3rem 0;" />
                            <p style="font-size: 13px; margin-bottom: 0rem;"><i class="bi bi-credit-card"
                                    style="color:#049bba"></i> มูลค่าทรัพย์
                                <?php 
                                if($ipro->p_price == ''){
                                    echo "x,xxx,xxx";
                                }else{ echo $ipro->p_price; } ?>
    ...
    <section id="featured-services" class="featured-services section-bg">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="<?php echo base_url('assets/img/news/' . $n->image_new); ?>" class="card-img-top"
                            src="..." alt="Card image cap" style="height: 380px;">
                        <div class="card-body">
    ...
    <section id="featured-services" class="featured-services section-bg">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <img src="<?php echo base_url('assets/img/even/' . $n->image_even); ?>" class="card-img-top"
                            src="..." alt="Card image cap" style="height:200px"  >
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $n->title; ?></h5>

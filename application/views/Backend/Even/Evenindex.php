        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <button type="button" class="btn btn-primary" data-toggle="modal"
                    data-target="#insertmodal">เพิ่มข้อมูลอีเว้น</button>
                <br /><br />
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <!-- `id``title``detail``savedate``update_date``status_even``image_even``userupdate` -->
                            ...
                            <td>
                                ...
                                <div id="Status<?php echo  $Even->id;?>">
                                    ...
                                    <button type="button" class="btn btn-danger btn-xs"
                                        ...
                                        onclick="statusupdate(<?php echo $Even->id ;?>)">
                                        ปิดการใช้งาน
                                    </button>
                            ...
                            <td><button type="button" onclick="showdetail(id = '<?php echo $Even->id ?>')"
                            ...
                            <td>
                                <button type="button" class="btn btn-danger btn-xs"
                                    style="color:white;font-size: 13px;border-radius: 5px;"
                                    onclick="deleteEvens(id ='<?php echo $Even->id ;?>', imag = '<?php echo $Even->image_even ?>')">
                                    ลบ
                                </button>
                            </td>
                        </tr>
